...
class GarminPayClientTest {
    @Test
    void cannotConstructWithNullValues() {
        assertThrows(IllegalArgumentException.class, () -> {
            new GarminPayClient(null, "testClientSecret");
        });

        assertThrows(IllegalArgumentException.class, () -> {
            new GarminPayClient("testClientId", null);
        });

        assertThrows(IllegalArgumentException.class, () -> {
            new GarminPayClient(null, null);
        });
    }
    ...
    void cannotConstructWithInvalidClientId(String invalidClientId) {
        assertThrows(IllegalArgumentException.class, () -> {
            new GarminPayClient(invalidClientId, "testClientSecret");
        });
    }
    ...
    void cannotConstructWithInvalidClientSecret(String invalidClientSecret) {
        assertThrows(IllegalArgumentException.class, () -> {
            new GarminPayClient("testClientId", invalidClientSecret);
        });
    }
}
